    ...
    useEffect(() => {
        const fetchAddress = async () => {
            const response = await fetch(
                `https://sfm-api-production.up.railway.app/api/address/${localStorage.getItem(
                    "userID"
                )}`
            );
        ...
        const fetchOrders = async () => {
            const response = await fetch(
                `https://sfm-api-production.up.railway.app/api/order/${localStorage.getItem(
                    "userID"
                )}`
            );
            const data = await response.json();
    ...
    useEffect(() => {
        const fetchOrderItems = async (orderID) => {
            if (selectedOrder !== null) {
                const response = await fetch(
                    `https://sfm-api-production.up.railway.app/api/order/item/${orderID}`
                );
                const data = await response.json();
                setOrderItems(data);
            }
