...
const Dashboard = () => {
        ...
        const fetchBranchRanking = async () => {
            try {
                const response = await fetch(
                    `https://sfm-api-production.up.railway.app/api/sales/branch`
                );
    ...
    useEffect(() => {
        const getCustomerCount = async () => {
            try {
                const response = await fetch(
                    `https://sfm-api-production.up.railway.app/api/customer/count/`
                );
        ...
        const getOrderCount = async () => {
            try {
                if (role === "ADM") {
                    const response = await fetch(
                        `https://sfm-api-production.up.railway.app/api/order/count/${admin.branchid}`
                    );
                ...
                if (role === "STF") {
                    const response = await fetch(
                        `https://sfm-api-production.up.railway.app/api/order/all/count/`
                    );
        ...
        const getProductCount = async () => {
            try {
                const response = await fetch(
                    "https://sfm-api-production.up.railway.app/api/product/count"
                );
        ...
        const getSaleCount = async () => {
            try {
                if (role === "ADM") {
                    const response = await fetch(
                        `https://sfm-api-production.up.railway.app/api/order/success/${admin.branchid}`
                    );
                    const jsonData = await response.json();
                ...
                if (role === "STF") {
                    const response = await fetch(
                        `https://sfm-api-production.up.railway.app/api/order/all/success/`
                    );
                    const jsonData = await response.json();
                    setSaleCount(jsonData.sum);
                }
        ...
        const fetchMonthlyProfit = async (month) => {
            try {
                const response = await fetch(
                    `https://sfm-api-production.up.railway.app/api/transaction_sum/${month}`
                );
